...
# Created on 2026/03/05 17:42:49
# ###########################################################################
...
BUILDID="FSAP-BPMN-UTILS"
REPORT_PATH="/var/jenkins_home/Fortify/reports/$BUILDID/$ENV/$(date +%Y%m%d_%H%M%S)"
FPR="$REPORT_PATH/$BUILDID.fpr"
ARGFILE="Fortify-FSAP-BPMN-UTILS.sh.args"
BYTECODE_ARGFILE="Fortify-FSAP-BPMN-UTILS.sh.bytecode.args"
MEMORY="-Xmx14165M -Xms400M -Xss24M "

LAUNCHERSWITCHES=""
SCANSWITCHES=""
OLDFILENUMBER="Fortify-FSAP-BPMN-UTILS.sh.fileno"
FILENOMAXDIFF=10
...
$SOURCEANALYZER $MEMORY $LAUNCHERSWITCHES -b $BUILDID -source 17 -Dfortify.sca.sqlType=TSQL ./gradlew bpmn-utils:clean bpmn-utils:build -x publishToMavenLocal -x check --stacktrace --console=plain --offline
if [ $? -ne 0 ] ; then
