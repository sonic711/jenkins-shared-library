...
# Created on 2026/03/04 14:14:26
# ###########################################################################
...
BUILDID="FSAP-RUNTIME"
REPORT_PATH="/var/jenkins_home/Fortify/reports/$BUILDID/$ENV/$(date +%Y%m%d_%H%M%S)"
FPR="$REPORT_PATH/$BUILDID.fpr"
ARGFILE="FortifyBOT-FORTIFY-FSAP-RUNTIME.sh.args"
BYTECODE_ARGFILE="FortifyBOT-FORTIFY-FSAP-RUNTIME.sh.bytecode.args"
MEMORY="-Xmx14165M -Xms400M -Xss24M "

LAUNCHERSWITCHES=""
SCANSWITCHES=""
OLDFILENUMBER="FortifyBOT-FORTIFY-FSAP-RUNTIME.sh.fileno"
FILENOMAXDIFF=10
...
PROJECTROOT0="/var/jenkins_home/workspace/BOT-FORTIFY-FSAP-RUNTIME"
...
$SOURCEANALYZER $MEMORY $LAUNCHERSWITCHES -b $BUILDID -source 17 -Dfortify.sca.sqlType=TSQL ./gradlew boot:runtime:clean boot:runtime:build -x publishToMavenLocal -x check  --stacktrace --console=plain --offline
if [ $? -ne 0 ] ; then
...
echo Finished
# ARGS "-cp"
# ARGS "PROJECTROOT0_MARKER/libs/TBConvert.jar:PROJECTROOT0_MARKER/gradle/wrapper/gradle-wrapper.jar"
# ARGS "-source"
# ARGS "17"
