...
# Created on 2026/03/05 09:32:38
# ###########################################################################
...
BUILDID="FSAP-GATEWAY"
REPORT_PATH="/var/jenkins_home/Fortify/reports/$BUILDID/$ENV/$(date +%Y%m%d_%H%M%S)"
FPR="$REPORT_PATH/$BUILDID.fpr"
ARGFILE="Fortify-FSAP-GATEWAY.sh.args"
BYTECODE_ARGFILE="Fortify-FSAP-GATEWAY.sh.bytecode.args"
MEMORY="-Xmx14165M -Xms400M -Xss24M "

LAUNCHERSWITCHES=""
SCANSWITCHES=""
OLDFILENUMBER="Fortify-FSAP-GATEWAY.sh.fileno"
FILENOMAXDIFF=10
...
PROJECTROOT0="/var/jenkins_home/workspace/FORTIFY-FSAP-GATEWAY"
...
$SOURCEANALYZER $MEMORY $LAUNCHERSWITCHES -b $BUILDID -source 17 -Dfortify.sca.sqlType=TSQL ./gradlew boot:fastgateway:clean boot:fastgateway:build -x check  --stacktrace --console=plain --offline
if [ $? -ne 0 ] ; then
...
echo Finished
# ARGS "-cp"
# ARGS "PROJECTROOT0_MARKER/etc/boot/lib/hello-world-boot-starter.jar:PROJECTROOT0_MARKER/gradle/wrapper/gradle-wrapper.jar:PROJECTROOT0_MARKER/libs/TBConvert.jar"
# ARGS "-source"
# ARGS "17"
...
# ARGS "-exclude" "PROJECTROOT0_MARKER/lombok.config"
