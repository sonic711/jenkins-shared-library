...
# Created on 2026/03/04 16:28:44
# ###########################################################################
...
ARGFILE="Fortify-NCB.sh.args"
BYTECODE_ARGFILE="Fortify-NCB.sh.bytecode.args"
MEMORY="-Xmx14165M -Xms400M -Xss24M "

LAUNCHERSWITCHES=""
SCANSWITCHES=""
OLDFILENUMBER="Fortify-NCB.sh.fileno"
FILENOMAXDIFF=10
...
PROJECTROOT0="/var/jenkins_home/workspace/FORTIFY-NCB"
...
$SOURCEANALYZER $MEMORY $LAUNCHERSWITCHES -b $BUILDID -source 17 -Dfortify.sca.sqlType=TSQL ./gradlew clean build -x check  --stacktrace --console=plain --offline
if [ $? -ne 0 ] ; then
