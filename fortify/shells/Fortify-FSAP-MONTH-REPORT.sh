...
# Created on 2026/05/28 17:28:28
# ###########################################################################
...
BUILDID="FSAP-MONTH-REPORT"
REPORT_PATH="/var/jenkins_home/Fortify/reports/$BUILDID/$ENV/$(date +%Y%m%d_%H%M%S)"
FPR="$REPORT_PATH/$BUILDID.fpr"
ARGFILE="Fortify-FSAP-MONTH-REPORT.sh.args"
BYTECODE_ARGFILE="Fortify-FSAP-MONTH-REPORT.sh.bytecode.args"
MEMORY="-Xmx21401M -Xms400M -Xss24M "

LAUNCHERSWITCHES=""
SCANSWITCHES=""
OLDFILENUMBER="Fortify-FSAP-MONTH-REPORT.sh.fileno"
FILENOMAXDIFF=10
...
PROJECTROOT0="/var/jenkins_home/workspace/FORTIFY-FSAP-MONTH-REPORT"
...
$SOURCEANALYZER $MEMORY $LAUNCHERSWITCHES -b $BUILDID -source 17 -Dfortify.sca.sqlType=TSQL ./gradlew clean bootJar --offline
if [ $? -ne 0 ] ; then
